pipeline {
    ...
    environment {
        DOCKER_HUB_REPO = 'sachinkumar04/microservice'
    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                git 'https://github.com/sachinkumar04/microservices-ingress-kastro.git'
            }
        }
        ...
        stage('Deploy to Kubernetes') {
            steps {
                ...
                script {
                    withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', credentialsId: 'aws-creds']]) {
                        sh "sed -i 's|sachinkumar04/microservice:latest|sachinkumar04/microservice:${env.IMAGE_TAG}|g' k8s/deployment.yaml"
